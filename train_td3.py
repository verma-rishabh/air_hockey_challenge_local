...
def main():
    ...
    parser.add_argument("--policy", default="TD3-single-r")                  # Policy name (TD3, DDPG or OurDDPG)
    ...
    parser.add_argument("--expl_noise", default=0.00)                # Std of Gaussian exploration noise
